var Autocomplete = (function() {
    ...
    var i = function(t, e) {
                ...
                n(this, 'checkSelectedResultVisible', function(t) {
                    ...
                    if (e) {
                        ...
                        o.top < n.top ?
                            ...
                            o.bottom > n.bottom && (t.scrollTop += o.bottom - n.bottom)
                    }
                }),
                (this.search = s(l) ?
                    l :
        ...
        d = (function() {
            function n(e, i, o) {
                t(this, n),
                    (this.id = ''.concat(o, '-result-').concat(e)),
                    (this.class = ''.concat(o, '-result')),
    ...
    return function e(i) {
        ...
        t(this, e),
            ...
            n(this, 'initialize', function() {;
                (o.root.style.position = 'relative'),
                o.input.setAttribute('role', 'combobox'),
                    o.input.setAttribute('autocomplete', 'off'),
                    o.input.setAttribute('autocapitalize', 'off'),
                    o.autocorrect && o.input.setAttribute('autocorrect', 'on'),
                    o.input.setAttribute('spellcheck', 'false'),
                    o.input.setAttribute('aria-autocomplete', 'list'),
                    o.input.setAttribute('aria-haspopup', 'listbox'),
                    o.input.setAttribute('aria-expanded', 'false'),
                    o.resultList.setAttribute('role', 'listbox'),
                    (o.resultList.style.position = 'absolute'),
                    (o.resultList.style.zIndex = '1'),
                    (o.resultList.style.width = '100%'),
                    (o.resultList.style.boxSizing = 'border-box'),
                    o.resultList.id ||
                    (o.resultList.id = r(''.concat(o.baseClass, '-result-list-'))),
                    o.input.setAttribute('aria-owns', o.resultList.id),
                    document.body.addEventListener('click', o.handleDocumentClick),
                    o.input.addEventListener('input', o.core.handleInput),
                    o.input.addEventListener('keydown', o.core.handleKeyDown),
                    o.input.addEventListener('focus', o.core.handleFocus),
                    o.input.addEventListener('blur', o.core.handleBlur),
                    o.resultList.addEventListener(
                        'mousedown',
                        o.core.handleResultMouseDown
                    ),
                    o.resultList.addEventListener('click', o.core.handleResultClick),
                    o.updateStyle()
            }),
            n(this, 'destroy', function() {
                document.body.removeEventListener('click', o.handleDocumentClick),
                    o.input.removeEventListener('input', o.core.handleInput),
                    o.input.removeEventListener('keydown', o.core.handleKeyDown),
                    o.input.removeEventListener('focus', o.core.handleFocus),
                    o.input.removeEventListener('blur', o.core.handleBlur),
                    o.resultList.removeEventListener(
                        'mousedown',
                        o.core.handleResultMouseDown
                    ),
                    o.resultList.removeEventListener('click', o.core.handleResultClick),
                    (o.root = null),
                    (o.input = null),
                    (o.resultList = null),
                    (o.getResultValue = null),
                    (o.onUpdate = null),
                    (o.renderResult = null),
                    o.core.destroy(),
                    (o.core = null)
            ...
            n(this, 'handleUpdate', function(t, e) {;
                (o.resultList.innerHTML = ''),
                t.forEach(function(t, n) {
                        var i = new d(n, e, o.baseClass),
                            s = o.renderResult(t, i)
                        'string' == typeof s
                            ?
                            o.resultList.insertAdjacentHTML('beforeend', s) :
                            o.resultList.insertAdjacentElement('beforeend', s)
                    }),
                    o.input.setAttribute(
                        'aria-activedescendant',
                        e > -1 ? ''.concat(o.baseClass, '-result-').concat(e) : ''
                    ),
                    o.resetPosition &&
                    ((o.resetPosition = !1),
                        (o.position = a(o.input, o.resultList)),
                        o.updateStyle()),
                    o.core.checkSelectedResultVisible(o.resultList),
                    o.onUpdate(t, e)
            }),
            ...
            n(this, 'updateStyle', function() {;
                (o.root.dataset.expanded = o.expanded),
                (o.root.dataset.loading = o.loading),
                (o.root.dataset.position = o.position),
                (o.resultList.style.visibility = o.expanded ? 'visible' : 'hidden'),
                (o.resultList.style.pointerEvents = o.expanded ? 'auto' : 'none'),
                'below' === o.position ?
                    ((o.resultList.style.bottom = null),
                        (o.resultList.style.top = '100%')) :
                    ((o.resultList.style.top = null),
                        (o.resultList.style.bottom = '100%'))
            }),
            ...
            (this.onUpdate = v),
            'function' == typeof R && (this.renderResult = R)
        var k = new u({
            search: l,
            autoSelect: g,
        ...
        A > 0 && (k.handleInput = c(k.handleInput, A)),
            (this.core = k),
            this.initialize()
    }
})()